...
export function PlayerBar() {
  ...
  return (
    ...
    <div className="glass-player fixed inset-x-0 bottom-0 z-20 flex h-player items-center justify-between border-t border-border px-4">
      {/* Track info */}
        ...
        {currentTrack ? (
          <>
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-caption text-text-secondary">{currentTrack.artist}</p>
            </div>
          </>
        ) : (
      ...
      <div className="flex w-1/2 max-w-xl flex-col items-center gap-1">
        ...
        <div className="w-full">
          <SeekBar positionSec={positionSec} durationSec={currentTrack?.durationSec ?? 0} onSeek={seek} />
        </div>
      </div>
