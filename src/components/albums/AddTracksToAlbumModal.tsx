...
import { useAddTrackToAlbumModal } from '@/hooks';
import * as Dialog from '@radix-ui/react-dialog';
import { Plus, Search, X } from 'lucide-react';

export interface IAddTracksToAlbumModalProps {
  open: boolean;
...
export function AddTracksToAlbumModal(props: IAddTracksToAlbumModalProps) {
  const { open, onOpenChange } = props;

  const { tracks, isLoading, handleAddTrackToAlbum, search, setSearch } =
    useAddTrackToAlbumModal(props);
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {tracks.map(track => (
              ...
              >
                ...
                <button
                  onClick={() => handleAddTrackToAlbum(track._id)}
