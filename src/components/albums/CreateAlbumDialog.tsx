...
import { useCreateAlbumDialog } from '@/hooks';
import * as Dialog from '@radix-ui/react-dialog';

export interface ICreateAlbumDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function CreateAlbumDialog(props: ICreateAlbumDialogProps) {
